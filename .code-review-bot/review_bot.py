...
# Style & security checks on added/modified text lines
new_content = get_file_contents(sha)
file_comments, file_summary = [], []
...
def create_review(pr_number: int, comments: List[Comment], summary_lines: List[str], event: str = "COMMENT"):
